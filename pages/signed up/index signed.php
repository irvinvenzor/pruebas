...
<ul>
  <li><a class="active" href="index signed.php"><?php echo $main ?></a></li>
  <li><a href="boing tienda.php"><?php echo $gal ?></a></li>
  ...
  <li style="float:right"><a href="../../index.php"><?php echo $logout ?></a></li>
</ul>
<h1><?php echo $tog ?></h1>
 	<p class="nature">
	...
	<div class="warm">
<h1><?php echo $vids ?></h1>
<iframe class="tscplayer_inline" id="embeddedSmartPlayerInstance" src="../Play comercial/campo/comercial_player.html?embedIFrameId=embeddedSmartPlayerInstance" scrolling="no" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
	<br>
  <br>	
<iframe class="tscplayer_inline" id="embeddedSmartPlayerInstance" src="../Play comercial/latas/comercial boing latas_player.html?embedIFrameId=embeddedSmartPlayerInstance" scrolling="no" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
