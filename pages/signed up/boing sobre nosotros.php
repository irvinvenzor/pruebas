...
if($conexion){
	...
	$sql= "SELECT * FROM txtabout WHERE lan='$idioma'";
...
<ul>
  <li><a  href="index signed.php"><?php echo $main ?></a></li>
  <li><a href="boing tienda.php"><?php echo $gal ?></a></li>
  <li><a  href="boing contacto.php"><?php echo $contact ?></a></li>
  <li><a class="active" href="boing sobre nosotros.php"><?php echo $about ?></a></li>
